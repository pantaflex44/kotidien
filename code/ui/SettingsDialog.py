...
class SettingsDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        checkboxes = [
            ...
            ['askOnClose', self.askOnClose],
            ['view_accounts_cb', self.view_accounts_cb],
            ['selective_expand', self.selective_expand],
            ['Accounts/default_sort_descending', self.default_sort_descending],
        ...
        for c in checkboxes:
            c[1].setCheckState(Qt.Checked if self._settings.value(c[0]) else Qt.Unchecked)
        ...
        idx = self.default_sort_column.findData(self._settings.value('Accounts/default_sort_column'))
        ...
        idx = self.default_filter_date.findData(self._settings.value('default_filter_date'))
        ...
        self.color_positive_amount_value = self._settings.value( 'color_positive_amount')
        self.color_positive_amount.setStyleSheet('background:{};color:#fff;'.format(self.color_positive_amount_value))
        self.color_positive_amount.clicked.connect(self.changePositiveColor)

        # color_negative_amount
        self.color_negative_amount_value = self._settings.value('color_negative_amount')
        ...
        # color_credit_amount
        self.color_credit_amount_value = self._settings.value('color_credit_amount')
        ...
        self.csv_separator.setText(self._settings.value('Export/csv_separator'))

        # Export/csv_decimal
        self.csv_decimal.setText(self._settings.value('Export/csv_decimal'))

        # Export/csv_dateformat
        self.csv_dateformat.setText(self._settings.value('Export/csv_dateformat'))
    ...
    def changePositiveColor(self):
        ...
        cc.setCustomColor(1, QColor(self._settings.value('color_positive_amount')))
    ...
    def changeNegativeColor(self):
        ...
        cc.setCustomColor(1, QColor(self._settings.value('color_negative_amount')))
    ...
    def changeCreditColor(self):
        ...
        cc.setCustomColor(1, QColor(self._settings.value('color_credit_amount')))
